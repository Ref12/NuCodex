...
namespace Codex.Analysis.Managed.Symbols
{
        ...
        where TSymbol : ISymbol
    {
        ...
        {
            if (InnerSymbol.Language == LanguageNames.VisualBasic)
            {
                return VB.SymbolDisplay.ToDisplayString(this, format);
            }
            else
            {
        ...
        public ImmutableArray<SymbolDisplayPart> ToDisplayParts(SymbolDisplayFormat format = null)
        {
            if (InnerSymbol.Language == LanguageNames.VisualBasic)
            {
                return VB.SymbolDisplay.ToDisplayParts(this, format);
            }
            else
            {
        ...
        public string ToMinimalDisplayString(SemanticModel semanticModel, int position, SymbolDisplayFormat format = null)
        {
            if (InnerSymbol.Language == LanguageNames.VisualBasic)
            {
                return VB.SymbolDisplay.ToMinimalDisplayString(this, semanticModel, position, format);
            }
            else
            {
        ...
        public ImmutableArray<SymbolDisplayPart> ToMinimalDisplayParts(SemanticModel semanticModel, int position, SymbolDisplayFormat format = null)
        {
            if (InnerSymbol.Language == LanguageNames.VisualBasic)
            {
                return VB.SymbolDisplay.ToMinimalDisplayParts(this, semanticModel, position, format);
            }
            else
            {
