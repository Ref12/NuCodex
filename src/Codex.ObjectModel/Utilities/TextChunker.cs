...
namespace Codex
{
    public static class TextChunker
    {
        ...
        private static void AddChunk(List<ListSegment<string>> chunks, IReadOnlyList<string> lines, int chunkStartIndex, int chunkEndIndex)
        {
            ...
            {
                chunks.Add(new ListSegment<string>(lines, chunkStartIndex, count: (chunkEndIndex - chunkStartIndex) + 1));
            }
        }
        ...
        private static bool IsPunctuationOrWhitespace(string line)
        {
